...
import com.facens.pooii.lab.ac1.ac1.services.AttendService;
...
public class AttendController {
    ...
    public ResponseEntity<Page<AttendDTO>> getAttendees(
        ...
        FilterAttendRequest filterRequest = FilterAttendRequest.of(name, email, balance);

        Page<AttendDTO> list = service.getAttends(pageRequest, filterRequest);
